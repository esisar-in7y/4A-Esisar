[kernel] Parsing sampleJ.c (with preprocessing)
[eva] Analyzing a complete application starting at main
[eva] Computing initial state
[eva] Initial state computed
[eva:initial-state] Values of globals at initialization
  
[eva] sampleJ.c:5: allocating variable __malloc_main_l5
[eva:alarm] sampleJ.c:8: Warning: 
  out of bounds write. assert \valid(p + (int)(-1));
[kernel] sampleJ.c:8: Warning: 
  all target addresses were invalid. This path is assumed to be dead.
[eva] done for function main
[eva] sampleJ.c:8: assertion 'Eva,mem_access' got final status invalid.
[eva] ====== VALUES COMPUTED ======
