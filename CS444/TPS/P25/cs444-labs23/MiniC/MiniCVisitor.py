# Generated from MiniC.g4 by ANTLR 4.9.3
from antlr4 import *
...
class MiniCVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by MiniCParser#funcDef.
    def visitFuncDef(self, ctx:MiniCParser.FuncDefContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by MiniCParser#printlnintStat.
    def visitPrintlnintStat(self, ctx:MiniCParser.PrintlnintStatContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MiniCParser#printlnfloatStat.
    def visitPrintlnfloatStat(self, ctx:MiniCParser.PrintlnfloatStatContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MiniCParser#printlnboolStat.
    def visitPrintlnboolStat(self, ctx:MiniCParser.PrintlnboolStatContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MiniCParser#printlnstringStat.
    def visitPrintlnstringStat(self, ctx:MiniCParser.PrintlnstringStatContext):
        return self.visitChildren(ctx)
